...
public class PlayerManager {
    ...
    public double expLeft;

    public String getPlayerName(Player p) {

        String str = " §6≪"+ TALSAPI.getPlayerDeta(p).getMainClass().getPrefix()+"§a: §fLv.§b"+TALSAPI.getPlayerDeta(p).getMainClass().getLevel()+"§6≫ §f"+p.getName()+" ";
    ...
    public void sendActionBar() {
        ...
        new BukkitRunnable() {
            ...
            public void run() {
                ...
                for (Player player : plugin.getServer().getOnlinePlayers()) {
                    ...
                    getExp = TALSAPI.getPlayerDeta(player).getMainClass().getExp();
                    getNextExp = TALSAPI.getPlayerDeta(player).getMainClass().getNextExp();
        ...
        Score score3 = objective.getScore("§7[" + TALSAPI.getPlayerDeta(p).getMainClass().getExp() + "/" + TALSAPI.getPlayerDeta(p).getMainClass().getNextExp() + "]");
        score3.setScore(11);

        Score score4 = objective.getScore(" ");
        score4.setScore(10);

        Score score5 = objective.getScore("§e§l??? §6§lG");
        score5.setScore(9);
